...
>(({ className = "", ...props }, ref) => (
  <div
    ref={ref}
    className={`w-96 rounded-3xl border border-neutral-100 bg-white p-5 font-sans shadow-lg ${className}`}
    {...props}
  >
    <div className="mb-4">
    ...
    <div className="mt-4 flex items-center justify-between rounded-2xl bg-neutral-50 p-3">
      ...
      <button className="flex cursor-pointer items-center gap-1 rounded-lg bg-neutral-900 px-3 py-2 text-[11px] font-medium text-white transition-colors hover:bg-black">
        Upgrade
        <ArrowRight size={12} />
      </button>
    </div>
