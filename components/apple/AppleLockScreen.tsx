...
>(({ className = "", ...props }, ref) => (
  <div ref={ref} className={`relative w-56 h-96 rounded-[2.5rem] overflow-hidden shadow-lg font-sans ${className}`} {...props}>
    ...
    <div className="relative z-10 h-full flex flex-col items-center pt-12">
      ...
      <div className="mt-6 w-[85%] bg-white/10 backdrop-blur-xl border border-white/15 rounded-2xl p-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#007AFF] flex items-center justify-center text-sm"><Chat/></div>
