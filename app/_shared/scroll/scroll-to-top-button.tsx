    ...
    >
      <span className="relative flex size-full items-center justify-center">
        ...
        <MoveUp
          size={14}
          strokeWidth={2}
          className="absolute translate-y-0.5 scale-95 opacity-0 transition-[opacity,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100"
        />
      </span>
    </button>
  );
