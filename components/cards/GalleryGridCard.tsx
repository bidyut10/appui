...
/**
 * Gallery Grid Card (Next.js + React + Tailwind)
 *
 * A modern photo grid component for portfolios, albums,
 * and gallery previews.
 *
 * Fully reusable, responsive-ready, and production-safe.
 */
export type GalleryGridCardProps = {
  title?: string;
  subtitle?: string;
