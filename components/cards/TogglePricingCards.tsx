    ...
    <div className="w-96 font-sans">
      <div className="flex items-center justify-center gap-3 mb-4">
        ...
        <button
          ...
          className={`relative w-11 h-6 rounded-full transition-colors cursor-pointer ${yearly ? "bg-neutral-800" : "bg-neutral-200"}`}
        >
          <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow-sm transition-transform ${yearly ? "translate-x-5.5" : "translate-x-0.5"}`} />
        </button>
