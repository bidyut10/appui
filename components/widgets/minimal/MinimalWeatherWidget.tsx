...
const FORECAST: { day: string; high: number; low: number; icon: ReactNode }[] = [
  ...
  { day: "Tue", high: 26, low: 17, icon: <Sun size={14} className="opacity-70" /> },
  ...
  (
    ...
    >
      <div className="mb-4 flex items-start justify-between">
        <div>
          <p className="font-mono text-4xl font-black tracking-wider">{temp}°</p>
      ...
      <div className="flex justify-between border-t border-neutral-800 pt-3">
        {FORECAST.map((d) => (
          <div key={d.day} className="text-center">
            ...
            <div className="my-1 flex justify-center text-neutral-300">{d.icon}</div>
