...
export const InsightPulseWidget = forwardRef<HTMLDivElement, InsightPulseWidgetProps>(
    ...
    return (
      ...
      >
        ...
        <svg viewBox="0 0 100 40" className="h-16 w-full" preserveAspectRatio="none">
          ...
          <path d={path} fill="none" stroke="#84cc16" strokeWidth="2" strokeLinecap="round" />
        </svg>
