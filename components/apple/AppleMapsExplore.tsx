...
>(({ className = "", ...props }, ref) => (
  <div
    ref={ref}
    className={`w-72 rounded-[1.25rem] overflow-hidden shadow-xl shadow-black/10 font-sans ${className}`}
    {...props}
  >
    <div className="relative h-48">
      ...
      <div className="absolute bottom-0 p-4">
        ...
        <h3 className="text-xl font-bold text-white mt-0.5 leading-tight">
          Sundarbans
        </h3>
        ...
        <div className="flex gap-2 mt-3 flex-wrap">
          <span className="px-2.5 py-1 bg-white/20 backdrop-blur-md border border-white/20 rounded-full text-[10px] font-medium text-white flex items-center gap-1.5">
            <Leaf size={11} />
            Parks
          </span>
