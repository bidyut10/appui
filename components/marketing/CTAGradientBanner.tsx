...
>(({ className = "", ...props }, ref) => (
  ...
  >
    ...
    <div className="relative z-10 p-6 text-center">
      ...
      <button className="inline-flex h-10 cursor-pointer items-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-teal-700 shadow-lg shadow-teal-900/20 transition-all hover:bg-white/90 active:scale-95">
        Get Started Free
        <ArrowRight size={14} />
      </button>
