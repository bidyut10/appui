...
>(({ className = "", ...props }, ref) => (
  ...
  >
    <div className="relative mx-auto w-24 h-24 mb-5">
      <div className="absolute inset-0 bg-linear-to-br from-violet-100 to-fuchsia-100 rounded-3xl rotate-6" />
    ...
    <button className="inline-flex items-center gap-1.5 h-9 px-5 bg-neutral-900 text-white text-xs font-medium rounded-xl hover:bg-neutral-800 transition-colors cursor-pointer active:scale-95">
      Create Project
      <ArrowRight size={12} />
    </button>
