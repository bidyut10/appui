...
/**
 * Channel lollipop card built with React, TypeScript, and Tailwind CSS.
 *
 * Replace the demo channel names, performance values, and colors with your own marketing data.
 */
  ...
  (
    ...
    >
      ...
      <div className="space-y-3">
        {(channels ?? []).map((ch) => {
          const safeValue = Math.max(0, Math.min(100, ch.value));
