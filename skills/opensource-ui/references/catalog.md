# Browse Free React & Next.js UI Components | Opensource UI
...
Free for personal and commercial use. No UI attribution required. MIT License. Made & maintained by Bidyut Kundu.
...
Apple Notification / Notifications
...
Booking Slot Calendar / Calender
...
File Upload Field Input / Inputs
...
Floating Label Field Input / Inputs
...
Incoming Call Notification / Notifications
...
Opensource Folder Tab Card / Folder
...
Radio Group Field Input / Inputs
...
Resource Links Panel / Resources
...
Team Member Profile Grid / Profile
...
Run terminals and coding agents in one window — organized by project, not chat tabs.
...
Your product, right where VelaTerm is — seen by every dev browsing components.
