...
>(
  (
    { className, day = "TUESDAY", timezone = "GMT+1", ...props },
    ref,
  ) => (
    <div
      ref={ref}
      ...
      className={cn(
        "flex h-44 w-44 flex-col justify-center rounded-[2rem] border border-neutral-200 bg-white p-4 font-sans shadow-lg",
        className,
      )}
      {...props}
    >
