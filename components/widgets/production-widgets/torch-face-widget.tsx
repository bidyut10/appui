...
function TorchMascot({ on }: TorchMascotProps) {
  return (
    <g aria-hidden>
      ...
      {on ? (
        <>
          <line x1="64" y1="121" x2="72" y2="123" stroke="white" strokeWidth="2.2" strokeLinecap="round" />
          <line x1="112" y1="121" x2="104" y2="123" stroke="white" strokeWidth="2.2" strokeLinecap="round" />
        </>
      ) : (
        <>
...
>(({ className, defaultOn = false, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "absolute inset-x-0 top-[34%] z-10 text-center text-base font-semibold leading-none",
