...
/**
 * Vintage notepad-inspired card built with React,
 * TypeScript, and Tailwind CSS.
 *
 * Replace the demo content with your own notes, quotes,
 * reminders, or checklist items.
 *
 * Need icons? Visit nexticons.in for free copy-paste icons.
 */
export type NotepadCardProps = {
  title?: string;
